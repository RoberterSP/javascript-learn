...
if(getUrlParameter()['org_id']) {
  window.localStorage.setItem('org_id', decodeURIComponent(getUrlParameter()['org_id']))
  org_id = decodeURIComponent(getUrlParameter()['org_id'])
}else {
...
if (process.env.NODE_ENV === 'development') {
  BASE_URL = 'http://139.219.98.41:4000'
} else {

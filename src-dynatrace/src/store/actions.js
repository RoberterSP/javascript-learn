...
import { ROLE_LIST_GET, OWNER_SOURCE_LSIT_GET, AUTH_SOURCE_LIST_GET } from '@/api'
 ...
 * @param roles
 */
function filterAsyncRouter(asyncRouterMaps, filterArray, rolesview) {
  const res = []

  ...
  <div>
    <div class="page p10">
      ...
      <div class="p-content p10t6">
        ...
        <nt-table class="table-list" :tableData="process_list||[]" :tableSet="tableSet" :columns="columns" v-if="showAddGroup===0"></nt-table>
...
export default {
  ...
  mounted () {
    if (this.$route.params && this.$route.params.nodeDetail) {
      ...
      // 设置左侧菜单为 serviceApi
      this.$parent.falt('serviceNode', false)
      this.readMeshNodeProcessList()
    } else {

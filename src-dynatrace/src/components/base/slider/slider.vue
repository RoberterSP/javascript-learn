<template>
  ...
  >
    ...
    <span
      class="nt-slider__demonstration"
      v-if="!!demonstration">
      {{demonstration}}
    </span>
    ...
    <div
      ...
      <div
        ...
        :class="elSliderBarType"
        :style="barStyle">
      </div>
      <slider-button
        :vertical="vertical"
        v-model="firstValue"
        :placement="startTooltip"
        :resident-tooltip="residentTooltip"
        :tooltip-class="tooltipClass"
        ref="button1">
      </slider-button>
      <slider-button
        :vertical="vertical"
        :placement="endTooltip"
        v-model="secondValue"
        :resident-tooltip="residentTooltip"
        :tooltip-class="tooltipClass"
        ref="button2"
  ...
  computed: {
    ...
    runwayStyle () {
      return this.vertical ? {height: this.height} : {
        marginRight: this.demonstration ? '200px' : ''
      }
    },

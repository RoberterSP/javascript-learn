...
module.exports = {
    ...
    output:{
        path:path.resolve(__dirname,'../webpackDemo'),
    ...
    plugins: [
        ...
        new UglifyJsPlugin(),
        new cleanWebpackPlugin("../webpackDemo/*.*", {
            root: __dirname,
            verbose: true,
            dry: false
        }),
    ...
    devServer: {
      contentBase: path.resolve(__dirname,'../webpackDemo'), //网站的根目录为 根目录/webpackDemo，这个路径一般与output.path一致，因为html插件生成的html5页是放在output.path这个目录下
      port: 9000, //端口改为9000
    ...
    mode: "development" // webpack --mode [production | development | none]
